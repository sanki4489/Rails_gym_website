...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { name: @instructor.name, phone: @instructor.phone, salary: @instructor.salary, speciality: @instructor.speciality } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { name: @instructor.name, phone: @instructor.phone, salary: @instructor.salary, speciality: @instructor.speciality } }
